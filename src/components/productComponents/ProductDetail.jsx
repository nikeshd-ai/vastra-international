    ...
    return (
        <>
            <ContactBanner
                breadcrumb="Shorts"
                title="SHORTS"
                heading="Casual Cotton Short"
                description="Above-knee flat-front short in peach-finish cotton with slanted pockets, a single back welt pocket and a 2 cm turned hem."
            />
